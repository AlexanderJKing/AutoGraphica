"""root.support_date_time_operations
...
class DateTimeOperations:
    ...
    def return_date_format(self, pd_series):
        ...
        """This function is used to calculate the correct format the date is specfied as in the datetime column in the DataFrame

        Parameters
        ----------
        pd_series: pd.Series
            A pandas 'Datetime' series, or a 'Text' series formatted as Datetime
        """
    ...
    def check_empty_time_data(self, pd_series):
        ...
        """This function checks to see whether the time data associated with a 'Datetime' type is empty (i.e. 00:00:00)
    ...
    def split_date_time(self, dataframe, col_name, count: int):
        ...
        """This function splits date and time information in a Datetime column.

        Parameters
        ----------
        dataframe: pd.DataFrame
            The DataFrame inputted by the user.
        col_name: str
            The name of the column containing Datetime information.
        count: int
            An integer to append to any new column names generated, to avoid naming conflicts with any original datetime columns.
        """
    ...
    def is_date(self, string, fuzzy=False):
        ...
        ----------
        string: str
            The string to check for a date.
        fuzzy: bool
    ...
    def acceptable_date_format(self, pd_series):
        ...
        """This function determines if a column in a DataFrame is likely to be of type 'Datetime' and the values are formatted like a date.
    ...
    def acceptable_time_format(self, pd_series):
        ...
        """This function determines if a column in a DataFrame is likely to be of type 'Datetime' and the values are formatted as time.
    ...
    def acceptable_date_time_format(self, pd_series):
        ...
        """This function determines if a column in a DataFrame is likely to be of type 'Datetime'
        and the values are formatted like a date and as time.
    ...
    def determine_date(self, pd_series):
        ...
        """This function evaluates a final 'date' answer, by determining whether:
            - dtype == 'object'
    ...
    def determine_time(self, pd_series):
        ...
        """This function evaluates a final 'time' answer, by determining whether:
            - dtype = 'object'
    ...
    def determine_date_and_time(self, pd_series):
        ...
        """This function evaluates a final 'date' and 'time' answer, by determining whether:
            - dtype = 'object'
    ...
    def main_converter(self, pd_series):
        ...
        """This function acts as a main evaluator in returning the correct answer as to how to convert a column to Datetime and parse date and time information.
    ...
    def convert_timedelta(self, value):
        ...
        "This function rounds a timedelta value to hour, with 2 decimal places (provided its originally in seconds - use 'dt.seconds')"
