...
class Plotting:
    ...
    def check_categorical_dtype(self, dataframe, column):
        ...
        """This function helps to avoid a 'TypeError' when using 'str' accessors. 
        ...
        dataframe: pd.DataFrame
            The DataFrame created from the file input from the user.
        column: str
            The name of the column of interest in the DataFrame."""
    ...
    def unique_threshold(self, pd_series, thresh_val=30):
        ...
        """This function helps to determine whether the number of values in the series, will actually fit as columns,
        If its more than the arbitrary 'thresh_val' then a different plot (like a facet plot, etc). should be recommended. 

        Parameters
        ----------
        pd_series: pd.Series
            The Series of interest in the DataFrame.
        thresh_val: int
            The threshold value after which the number of unique values should be considered too cardinal to plot.
        """
    ...
    def create_title(self, custom_title: str, chart_type: str, axis_variable1, axis_variable2=None, current_style=None):
        ...
        """This function creates the title of the plot, dependent on the chart type.
        
        Parameters
        ----------
        custom_title: str
            A custom title available for the user to submit.
        chart_type:
            The chart type specified by the user.
        axis_variable1: str
            The name of a column to plot along axis1.
        axis_variable2: str
            The name of a column to plot along axis2.
        current_style: str
            The current style of the plot.
        """
    ...
    def create_legend(self, legend_on: str, chart_type: str, axis_variable1, axis_variable2=None,
        ...
        """This function creates the legend of the plot, dependent on the chart_type.

        Parameters
        ----------
        legend_on: str
            The string input determining whether the legend is displayed or not
        chart_type: str
            The chart type inputted by the user
        axis_variable1: str
            The name of a column to plot along axis1.
        axis_variable2: str
            The name of a column to plot along axis2.
        color_code: str
            The color inputted by the user. Any acceptable Matplotlib color can be provided.
        patches: plt.patches.Patch
            A patch is a 2D artist with a face color and an edge color.
        font_size: int
            The size of the font in the legend.
        bbox_anchor: int
            How the legend is positioned in relation to the figure.
        figure: plt.Figure
            A Matplotlib Figure object.
        legend_title: str
            The title of the legend, as determined by the user (default title provided).
        current_style: str
            The current style of the plot (any available Matplotlib style).
        """
    ...
    def set_xaxis_rotation(self, user_xtick_rotation, pd_series, orientation=None):
        ...
        """This function checks the character length of each string, in this case, column values that are categorical:
        ...
        Parameters
        ----------
        user_xtick_rotation: int
            The user inputted rotation for all 'x-axis' ticks.
        pd_series: pd.Series
            The Series of interest in the DataFrame.
        orientation: str
            The orientation of the plot (vertical/horizontal).
        """
    ...
    def check_valid_color(self, custom_color, palette=None):
        ...
        """This function checks to see whether the color entered by the user is valid.

        Parameters
        ----------
        custom_color: str
            The color submitted by the user
        palette:
            The palette selected by the user.
        """
    ...
    def define_edgecolor(self, current_style):
        ...
        "This function defines an appropriate edgecolor for plot objects based on the chosen Matplotlib style."
    ...
    def check_palette_type(self, chosen_palette):
        ...
        "Thsi function defines an appropriate text color for label objects based on the chosen palette style."
    ...
    def prioritise_color(self, color_code, palette):
        ...
        """This function defines an order of prioritisation based on any clashes between color codes and palettes inputted at the same time.
    ...
    def space_legend_out(self, pd_series, space_legend_out_):
        ...
        """This function helps to space the legend out in relation to the figure position.
        
        Parameters
        ----------
        pd_series: pd.Series
            The Series of interest in the DataFrame.
        space_legend_out_: float
            The value upon which to move the legend out in relation to the figure.
        """
    ...
    def pie_chart_size_parameters(self, pd_series, donut=False):
        ...
        """This function determines the size and positioning of the pie chart text and font.
        
        Parameters
        ----------
        pd_series: pd.Series
            The Series of interest within the DataFrame.
        donut: bool
            The value that determines whether the pie chart will be a donut chart or not.
        """
    ...
    def create_percentage_data(self, pd_series):
        ...
        "This function creates a Series of percentage data for displaying a Series applicable for a Pie Chart as a percentage instead of an absolute value."
    ...
    def explode_slice(self, pd_series, chosen_slice):
        ...
        """This function allows the user the option to explode either the 'largest' or 'smallest' slice in the Pie Chart.
        ...
        pd_series: pd.Series
            The Series of interest within the DataFrame. 
        chosen_slice: str
            The slice selected ('largest', 'smallest') that the user wishes to explode.
        """
    ...
    def apply_donut(self, donut, current_style):
        ...
        """This function allows the user to convert the Pie Chart into a Donut Chart.

        Parameters
        ----------
        donut: str
            This string input determines whether to convert the Pie Chart into a Donut Chart. 
        current_style: str
            The current Matplotlib style for all plots.
        """
    ...
    def apply_rotation(self, rotation):
        ...
        "This function allows the user to rotate the Pie/Donut chart by a given rotation."
